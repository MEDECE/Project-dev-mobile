...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      ecoscore: _parseecoscore(json['ecoScoreGrade']),
  ...
  static Productecoscore _parseecoscore(dynamic value) {
    return switch (value?.toString().toLowerCase()) {
      'a+' || 'a-plus' => Productecoscore.APlus,
      'a' => Productecoscore.A,
      'b' => Productecoscore.B,
      'c' => Productecoscore.C,
      'd' => Productecoscore.D,
...
enum Productecoscore { A, APlus, B, C, D, E, F, unknown }
