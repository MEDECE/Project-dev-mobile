...
class ProductImageHeader extends StatelessWidget {
  ...
  static const double kImageHeight = 362.0;
...
class ProductNameHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Product product = context.read<Product>();
    final currentTab = context.watch<ProductDetailsCurrentTab>();
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (currentTab == ProductDetailsCurrentTab.summary &&
                  product.altName != null &&
                  product.altName!.isNotEmpty) ...[
                const SizedBox(height: 3.0),
                Text(product.altName!, style: context.theme.altText),
              ],
