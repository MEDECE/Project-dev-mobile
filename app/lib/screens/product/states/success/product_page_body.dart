...
class _ProductPageBodyState extends State<ProductPageBody> {
  ...
  late final ValueNotifier<ProductDetailsCurrentTab> _tabNotifier;

  @override
  void initState() {
    super.initState();
    _tab = ProductDetailsCurrentTab.summary;
    _tabNotifier = ValueNotifier(ProductDetailsCurrentTab.summary);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableProvider<ProductDetailsCurrentTab>.value(
      value: _tabNotifier,
      child: Provider<Product>(
        create: (_) =>
          ...
          children: [
            ...
            BottomNavigationBar(
              ...
              onTap: (int position) => setState(() {
                ...
                _tabNotifier.value = ProductDetailsCurrentTab.values[position];
              }),
